...
public class MavenLoggerToSlf4j implements Logger {
    ...
    @Override public void trace(String fmt, Object a, Object b) { mavenLog.debug(format(fmt, a, b)); }
    @Override public void trace(String fmt, Object... args) { mavenLog.debug(format(fmt, args)); }
    ...
    @Override public void trace(Marker m, String fmt, Object a, Object b) { mavenLog.debug(format(fmt, a, b)); }
    @Override public void trace(Marker m, String fmt, Object... args) { mavenLog.debug(format(fmt, args)); }
    ...
    @Override public void debug(String fmt, Object a, Object b) { mavenLog.debug(format(fmt, a, b)); }
    @Override public void debug(String fmt, Object... args) { mavenLog.debug(format(fmt, args)); }
    ...
    @Override public void debug(Marker m, String fmt, Object a, Object b) { mavenLog.debug(format(fmt, a, b)); }
    @Override public void debug(Marker m, String fmt, Object... args) { mavenLog.debug(format(fmt, args)); }
    ...
    @Override public void info(String fmt, Object a, Object b) { mavenLog.info(format(fmt, a, b)); }
    @Override public void info(String fmt, Object... args) { mavenLog.info(format(fmt, args)); }
    ...
    @Override public void info(Marker m, String fmt, Object a, Object b) { mavenLog.info(format(fmt, a, b)); }
    @Override public void info(Marker m, String fmt, Object... args) { mavenLog.info(format(fmt, args)); }
    ...
    @Override public void warn(String fmt, Object a, Object b) { mavenLog.warn(format(fmt, a, b)); }
    @Override public void warn(String fmt, Object... args) { mavenLog.warn(format(fmt, args)); }
    ...
    @Override public void warn(Marker m, String fmt, Object a, Object b) { mavenLog.warn(format(fmt, a, b)); }
    @Override public void warn(Marker m, String fmt, Object... args) { mavenLog.warn(format(fmt, args)); }
    ...
    @Override public void error(String fmt, Object a, Object b) { mavenLog.error(format(fmt, a, b)); }
    @Override public void error(String fmt, Object... args) { mavenLog.error(format(fmt, args)); }
    ...
    @Override public void error(Marker m, String fmt, Object a, Object b) { mavenLog.error(format(fmt, a, b)); }
    @Override public void error(Marker m, String fmt, Object... args) { mavenLog.error(format(fmt, args)); }
